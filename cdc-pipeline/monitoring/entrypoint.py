...
PAIMON_WAREHOUSE = os.environ.get("PAIMON_WAREHOUSE", "s3://${BUCKET_NAME}/paimon-warehouse/")
ICEBERG_WAREHOUSE = os.environ.get("ICEBERG_WAREHOUSE", "s3://${BUCKET_NAME}/iceberg-warehouse/")
