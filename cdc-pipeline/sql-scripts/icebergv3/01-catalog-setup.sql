...
--   GLUE_DATABASE: AWS Glue database name (e.g., flink_icebergv3_db)
...
CREATE CATALOG icebergv3_catalog WITH (
    ...
    'catalog-name' = 'icebergv3_glue_catalog',
    'catalog-database' = '${GLUE_DATABASE:flink_icebergv3_db}',
...
CREATE DATABASE IF NOT EXISTS ${GLUE_DATABASE:flink_icebergv3_db};
